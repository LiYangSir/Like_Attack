...
def save(target, disturb, dataset):
    if dataset == 'mnist':
    ...
    # scipy.misc.imsave('./output/{}/{}/result/{}.jpg'.format(dataset, i), image[0].cpu().numpy().transpose((1, 2, 0)))
...
if __name__ == '__main__':
    ...
    for i, target in enumerate(result['x_data']):
        ...
        save(target, disturb_image, args.dataset)
